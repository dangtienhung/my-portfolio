const ContactLayout = () => {
    ...
    <section class='px-[4%] py-20 min-h-screen' id='contact'>
      <h4 class="uppercase text-sm text-gray-400 transition-all duration-1000">GET IN TOUCH</h4>
      <h2 class='uppercase text-3xl font-medium mt-8 leading-10 transition-all duration-1000'>CONTACT</h2>
